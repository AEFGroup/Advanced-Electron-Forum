...
<td class="bbcl"></td>
<td class="bbc" width="22" onmouseover="this.className='bbcon'" onmouseout="this.className='bbc'"><a href="javascript:url();" title="Anchor Link"><img src="<?php echo $theme['images'];?>bbc/hyperlink.gif" alt="Anchor Link" /></a></td><?php 

$dmenus[] = '<div id="url" class="lpb">
...
';?>
<td class="bbc" width="22" onmouseover="this.className='bbcon'" onmouseout="this.className='bbc'"><a href="javascript:ftp();" title="FTP Link"><img src="<?php echo $theme['images'];?>bbc/ftp.gif" alt="FTP Link" /></a></td><?php 

$dmenus[] = '<div id="ftp" class="lpb">
...
';?>
<td class="bbc" width="22" onmouseover="this.className='bbcon'" onmouseout="this.className='bbc'"><a href="javascript:email();" title="Email Link"><img src="<?php echo $theme['images'];?>bbc/email.png" alt="Email Link" /></a></td><?php 

$dmenus[] = '<div id="email" class="lpb">
